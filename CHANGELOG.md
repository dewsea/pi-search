...
- Added repository-only reference adapters for DeepSeek, Doubao Search, Exa, Firecrawl, Gemini, iFlow, and Serper under `examples/providers/`; they remain excluded from built-in registration and the npm artifact.
