...
The one-time bootstrap publication and first OIDC release were completed on 2026-08-16. `0.1.3` is the current published release and the npm `latest` dist-tag. The temporary `0.1.0-oidc-bootstrap.0` registry record is an unsupported historical version and must remain deprecated; it has no Git tag and must not be reused or unpublished.
